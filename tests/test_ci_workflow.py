...
class TestCiWorkflowActionPins:
    ...
    def test_setup_python_keeps_python_3_12(self) -> None:
        """O workflow deve continuar fixando python-version 3.12."""
        setup_step = next(
            step
        ...
        assert setup_step["with"]["python-version"] == "3.12", (
            "python-version do setup-python deve permanecer 3.12"
        )
